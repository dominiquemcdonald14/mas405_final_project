...
artist_text <- Corpus(VectorSource(artists_complete[,3])); artist_text
...
names(artist_keyword) <- artists_complete$Artist
artist_keyword[28] #look at the data frame one at a time otherwise your computer won't like you

dbListTables(con)

artist_keyword[20:40] #run this from your console to see results more easily
